...
object Num43 {
                ...
                override def inputGHDMZSK(num5: () => ghdmzsk): ghdmzsk = new ghdmzsk {
                  override def inputGHDMZSK(num6: () => ghdmzsk): ghdmzsk =
                    appendInnstance().inputGHDMZSK(() =>
                      num2().inputGHDMZSK(num3).inputGHDMZSK(num4).inputGHDMZSK(num5).inputGHDMZSK(num6).inputGHDMZSK(tail1)
                    )
                }
              }
            }
            ...
            override def inputGHDMZSK(num3: () => ghdmzsk): ghdmzsk = new ghdmzsk {
              override def inputGHDMZSK(num4: () => ghdmzsk): ghdmzsk = new ghdmzsk {
                override def inputGHDMZSK(num5: () => ghdmzsk): ghdmzsk = new ghdmzsk {
                  override def inputGHDMZSK(num6: () => ghdmzsk): ghdmzsk =
                    appendInnstance().inputGHDMZSK(() =>
                      num6().inputGHDMZSK(tail1).inputGHDMZSK(num2).inputGHDMZSK(num3).inputGHDMZSK(num4).inputGHDMZSK(num5)
                    )
                }
              }
            }
  ...
  object Append2 {
    ...
    val tailToRight: ghdmzsk = new ghdmzsk {
      override def inputGHDMZSK(tail1: () => ghdmzsk): ghdmzsk = new ghdmzsk with Num1 {
