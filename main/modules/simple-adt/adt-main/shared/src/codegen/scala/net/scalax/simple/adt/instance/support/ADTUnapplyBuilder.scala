...
trait ADTUnapplyBuilder {
  ...
  trait ADTOptionsUnapply1 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply2 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply3 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply4 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply5 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply6 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply7 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply8 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None, _ => None)
  ...
  trait ADTOptionsUnapply9 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None, _ => None)
  ...
  trait ADTOptionsUnapply10 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t), _ => None)
  ...
  trait ADTOptionsUnapply11 {
    ...
    def unapply[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11](
      ...
      p.fold(_ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, _ => None, t => Some(t))
