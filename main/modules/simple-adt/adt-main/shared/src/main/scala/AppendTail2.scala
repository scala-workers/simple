...
object AppendTailHelper2 {
  ...
  implicit def appendAbs1[XAA, S, CA <: AdtCoProduct.Use.AdtType, CB <: AdtCoProduct.Use.AdtType](implicit
  ...
  def appendByDefault[U, Z1 <: AdtCoProduct.Use.AdtType, Z2 <: AdtCoProduct.Use.AdtType](
