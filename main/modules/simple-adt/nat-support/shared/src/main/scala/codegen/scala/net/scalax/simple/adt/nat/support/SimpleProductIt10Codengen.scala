  ...
  def toItera[F[_[_]], T](
    ...
    new SimpleProductContextX[TPF] {
      ...
      override def simpleProduct11: SimpleProduct11.ProductAdapter[TPF] = new SimpleProduct11.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[_], N10[_], N11[
          _
        ]](
          ...
          TPF[({ type NXX[_] = N9[T] })#NXX],
          TPF[({ type NXX[_] = N10[T] })#NXX],
          TPF[({ type NXX[_] = N11[T] })#NXX]
        ] =
          spc.simpleProduct11.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            ({ type NXX[_] = N9[T] })#NXX,
            ({ type NXX[_] = N10[T] })#NXX,
            ({ type NXX[_] = N11[T] })#NXX
          ](
            new SimpleProduct11.TypeGen[
              M,
              ({ type NXX[_] = N1[T] })#NXX,
              ({ type NXX[_] = N2[T] })#NXX,
              ({ type NXX[_] = N3[T] })#NXX,
      ...
      override def simpleProduct12: SimpleProduct12.ProductAdapter[TPF] = new SimpleProduct12.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[_], N10[
          _
        ], N11[_], N12[_]](
          ...
          TPF[({ type NXX[_] = N10[T] })#NXX],
          TPF[({ type NXX[_] = N11[T] })#NXX],
          TPF[({ type NXX[_] = N12[T] })#NXX]
        ] =
          spc.simpleProduct12.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            ({ type NXX[_] = N10[T] })#NXX,
            ({ type NXX[_] = N11[T] })#NXX,
            ({ type NXX[_] = N12[T] })#NXX
          ](
            new SimpleProduct12.TypeGen[
              M,
              ({ type NXX[_] = N1[T] })#NXX,
              ({ type NXX[_] = N2[T] })#NXX,
              ({ type NXX[_] = N3[T] })#NXX,
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T]] =
                typeGen.gen[T]
            },
            sAppender
          )
      ...
      override def simpleProduct13: SimpleProduct13.ProductAdapter[TPF] = new SimpleProduct13.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[_], N10[
          _
        ], N11[_], N12[_], N13[_]](
          ...
          TPF[({ type NXX[_] = N11[T] })#NXX],
          TPF[({ type NXX[_] = N12[T] })#NXX],
          TPF[({ type NXX[_] = N13[T] })#NXX]
        ] =
          spc.simpleProduct13.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct13.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T]] =
                typeGen.gen[T]
            },
            sAppender
          )
      ...
      override def simpleProduct14: SimpleProduct14.ProductAdapter[TPF] = new SimpleProduct14.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[_], N10[
          _
        ], N11[_], N12[_], N13[_], N14[_]](
          ...
          TPF[({ type NXX[_] = N12[T] })#NXX],
          TPF[({ type NXX[_] = N13[T] })#NXX],
          TPF[({ type NXX[_] = N14[T] })#NXX]
        ] =
          spc.simpleProduct14.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct14.TypeGen[
              ...
              override def gen[U1]
                : M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct15: SimpleProduct15.ProductAdapter[TPF] = new SimpleProduct15.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[
          _
        ], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_]](
          ...
          TPF[({ type NXX[_] = N13[T] })#NXX],
          TPF[({ type NXX[_] = N14[T] })#NXX],
          TPF[({ type NXX[_] = N15[T] })#NXX]
        ] =
          spc.simpleProduct15.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct15.TypeGen[
              ...
              override def gen[U1]
                : M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[T], N15[T]] =
                typeGen.gen[T]
            },
            sAppender
          )
      ...
      override def simpleProduct16: SimpleProduct16.ProductAdapter[TPF] = new SimpleProduct16.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[_], N9[
          _
        ], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_]](
          ...
          TPF[({ type NXX[_] = N14[T] })#NXX],
          TPF[({ type NXX[_] = N15[T] })#NXX],
          TPF[({ type NXX[_] = N16[T] })#NXX]
        ] =
          spc.simpleProduct16.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct16.TypeGen[
              ...
              override def gen[U1]
                : M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[T], N15[T], N16[T]] =
                typeGen.gen[T]
            },
            sAppender
          )
      ...
      override def simpleProduct17: SimpleProduct17.ProductAdapter[TPF] = new SimpleProduct17.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[
          _
          ...
          TPF[({ type NXX[_] = N15[T] })#NXX],
          TPF[({ type NXX[_] = N16[T] })#NXX],
          TPF[({ type NXX[_] = N17[T] })#NXX]
        ] =
          spc.simpleProduct17.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct17.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct18: SimpleProduct18.ProductAdapter[TPF] = new SimpleProduct18.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[
          _
        ], N9[_], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_], N17[_], N18[_]](
          ...
          TPF[({ type NXX[_] = N16[T] })#NXX],
          TPF[({ type NXX[_] = N17[T] })#NXX],
          TPF[({ type NXX[_] = N18[T] })#NXX]
        ] =
          spc.simpleProduct18.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            ({ type NXX[_] = N16[T] })#NXX,
            ({ type NXX[_] = N17[T] })#NXX,
            ({ type NXX[_] = N18[T] })#NXX
          ](
            new SimpleProduct18.TypeGen[
              M,
              ({ type NXX[_] = N1[T] })#NXX,
              ({ type NXX[_] = N2[T] })#NXX,
              ({ type NXX[_] = N3[T] })#NXX,
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T], N18[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct19: SimpleProduct19.ProductAdapter[TPF] = new SimpleProduct19.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[_], N8[
          _
        ], N9[_], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_], N17[_], N18[_], N19[_]](
          ...
          TPF[({ type NXX[_] = N17[T] })#NXX],
          TPF[({ type NXX[_] = N18[T] })#NXX],
          TPF[({ type NXX[_] = N19[T] })#NXX]
        ] =
          spc.simpleProduct19.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct19.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T], N18[T], N19[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct20: SimpleProduct20.ProductAdapter[TPF] = new SimpleProduct20.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[
          _
        ], N8[_], N9[_], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_], N17[_], N18[_], N19[_], N20[_]](
          ...
          TPF[({ type NXX[_] = N18[T] })#NXX],
          TPF[({ type NXX[_] = N19[T] })#NXX],
          TPF[({ type NXX[_] = N20[T] })#NXX]
        ] =
          spc.simpleProduct20.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct20.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T], N18[T], N19[T], N20[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct21: SimpleProduct21.ProductAdapter[TPF] = new SimpleProduct21.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[_], N7[
          _
        ], N8[_], N9[_], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_], N17[_], N18[_], N19[_], N20[_], N21[_]](
          typeGen: SimpleProduct21.TypeGen[
            M,
            N1,
            N2,
            N3,
          ...
          TPF[({ type NXX[_] = N19[T] })#NXX],
          TPF[({ type NXX[_] = N20[T] })#NXX],
          TPF[({ type NXX[_] = N21[T] })#NXX]
        ] =
          spc.simpleProduct21.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct21.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T], N18[T], N19[T], N20[T], N21[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
      ...
      override def simpleProduct22: SimpleProduct22.ProductAdapter[TPF] = new SimpleProduct22.ProductAdapter[TPF] {
        override def append[M[_, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _], N1[_], N2[_], N3[_], N4[_], N5[_], N6[
          _
        ], N7[_], N8[_], N9[_], N10[_], N11[_], N12[_], N13[_], N14[_], N15[_], N16[_], N17[_], N18[_], N19[_], N20[_], N21[_], N22[_]](
          ...
          TPF[({ type NXX[_] = N20[T] })#NXX],
          TPF[({ type NXX[_] = N21[T] })#NXX],
          TPF[({ type NXX[_] = N22[T] })#NXX]
        ] =
          spc.simpleProduct22.append[
            M,
            ({ type NXX[_] = N1[T] })#NXX,
            ({ type NXX[_] = N2[T] })#NXX,
            ({ type NXX[_] = N3[T] })#NXX,
            ...
            new SimpleProduct22.TypeGen[
              ...
              override def gen[U1]: M[N1[T], N2[T], N3[T], N4[T], N5[T], N6[T], N7[T], N8[T], N9[T], N10[T], N11[T], N12[T], N13[T], N14[
                T
              ], N15[T], N16[T], N17[T], N18[T], N19[T], N20[T], N21[T], N22[T]] = typeGen.gen[T]
            },
            sAppender
          )
      }
