    ...
    with AdtInstanceFuncAbs2[M1, M2, M3, CoProduct1, APCoProduct1, CoZero1, Product2, APProduct2, ProZero2, CoProduct3, APCoProduct3, CoZero3] {
      ...
      AdtFunctionSupportSelf.appendSimpleAdt[T1, N1, APCoProduct1[M1[T2, N2], CoZero1], APProduct2[M2[T2, N2], ProZero2], APCoProduct3[M3[T2, N2], CoZero3]](
      ...
      AdtFunctionSupportSelf.appendSimpleAdt[T1, N1, APCoProduct1[M1[T2, N2], APCoProduct1[M1[T3, N3], CoZero1]], APProduct2[M2[T2, N2], APProduct2[M2[T3, N3], ProZero2]], APCoProduct3[M3[T2, N2], APCoProduct3[M3[T3, N3], CoZero3]]](
      ...
      AdtFunctionSupportSelf.appendSimpleAdt[T1, N1, APCoProduct1[M1[T2, N2], APCoProduct1[M1[T3, N3], APCoProduct1[M1[T4, N4], CoZero1]]], APProduct2[M2[T2, N2], APProduct2[M2[T3, N3], APProduct2[M2[T4, N4], ProZero2]]], APCoProduct3[M3[T2, N2], APCoProduct3[M3[T3, N3], APCoProduct3[M3[T4, N4], CoZero3]]]](
