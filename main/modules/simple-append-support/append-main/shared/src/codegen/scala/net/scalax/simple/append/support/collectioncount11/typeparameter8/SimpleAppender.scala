...
trait SimpleAppender[
  ...
  App7[_, _, _, _, _, _, _, _, _, _, _, _ <: Col7] <: Col7,
  App8[_, _, _, _, _, _, _, _, _, _, _, _ <: Col8] <: Col8,
  ColIns1 <: Col1,
  ColIns2 <: Col2,
  ColIns3 <: Col3,
  ColIns4 <: Col4,
  ...
  def next[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11]: SimpleAppender[
    ...
    App7[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, ColIns7],
    App8[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, ColIns8]
  ]
}
