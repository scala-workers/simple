...
object GetFieldModel {
  ...
  def appender[Sum, X1[_]]: AppenderSupport1.Simple2.Appender[
    ({ type HE[U1, U2] = TestGenericHelper[Sum, U1, U2] })#HE,
    X1,
  ...
  def zero[Sum]: AppenderSupport1.Simple2.Zero[({ type HE[U1, U2] = TestGenericHelper[Sum, U1, U2] })#HE] =
    new AppenderSupport1.Simple2.Zero[({ type HE[U1, U2] = TestGenericHelper[Sum, U1, U2] })#HE] {
